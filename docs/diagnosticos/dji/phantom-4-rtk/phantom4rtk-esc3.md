...
Durante operación de vuelo, el dron comenzó a inclinarse hacia el lado izquierdo. Posteriormente apareció un error relacionado al ESC 3.

## Síntomas observados
- Tendencia del dron a cargarse hacia un lado.
- Error ESC 3 durante vuelo o tras reinicio.

![Error ESC 3](../../../assets/phantom4rtk-esc3-diagnostico/ESC3_ERROR.png){ .center-img }
...
## ESC 3 (MOSFET dañado)
![ESC 3 Pin G Dañado](../../../assets/phantom4rtk-esc3-diagnostico/ESC3.jpeg){ .center-img }

## ESC 4 (Referencia Visual Sana de MOSFET)
![ESC 1 Referencia Sana](../../../assets/phantom4rtk-esc3-diagnostico/ESC_SANA.jpeg){ .center-img }
